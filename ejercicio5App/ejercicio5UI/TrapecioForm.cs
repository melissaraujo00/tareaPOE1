    ...
    public partial class TrapecioForm : Form
    {
        ...
        private void calcularButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Trapecio trapecio = new Trapecio(baseMayor, baseMenor, ladosParalelos, alturaTrapecio);
                decimal areaTrapecio = trapecio.CalcularArea();
                decimal perimetroTrapecio = trapecio.CalcularPerimetro();
