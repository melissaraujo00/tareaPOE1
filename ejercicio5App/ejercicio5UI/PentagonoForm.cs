    ...
    public partial class PentagonoForm : Form
    {
        ...
        private void calcularButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Pentagono pentagono = new Pentagono(longitudLado, apotemaPentagono);
                decimal areaPentagono = pentagono.CalcularArea();
                decimal perimetroPentagono = pentagono.CalcularPerimetro();
